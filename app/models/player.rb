class Player < ActiveRecord::Base
  ...
  def retrieve_at_bat_batter_records(result, year)
  ...
  def retrieve_game_batter_records(result, year)
  ...
  def game_pitcher_records_this_year(year)
  ...
  def retrieve_game_pitcher_records(result, year)
